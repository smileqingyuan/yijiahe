package com.moowu.framework.aspectj;

import cn.dev33.satoken.stp.StpUtil;
import com.alibaba.fastjson2.JSON;
import com.moowu.framework.manager.AsyncManager;
import com.moowu.framework.manager.factory.AsyncFactory;
import com.moowu.common.annotation.Log;
import com.moowu.common.core.domain.model.LoginUser;
import com.moowu.common.enums.BusinessStatusEnum;
import com.moowu.common.filter.PropertyPreExcludeFilter;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            // 获取当前的用户
            LoginUser loginUser = (LoginUser) StpUtil.getSession().get(StpUtil.getTokenValue());
